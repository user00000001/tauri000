import { Form, Input, InputNumber, Slider, Space, Typography, Watermark } from "antd";
...
export const MultiLineWatermark: React.FC = () => (
...
export default [
  {
    label: "Watermark - Basic",
    children: React.createElement(Basic),
  },
  {
    label: "Watermark - Multi-line watermark",
    children: React.createElement(MultiLineWatermark),
  },
  {
    label: "Watermark - Image watermark",
    children: React.createElement(ImageWatermark),
  },
  {
    label: "Watermark - Custom configuration",
    children: React.createElement(CustomConfiguration),
  },
]